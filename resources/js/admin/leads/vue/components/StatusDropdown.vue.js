// StatusDropdown Vue Component - Compiled for Browser
window.StatusDropdown = {
        ...
        >
          ...
          <div v-else-if="filteredStatuses.length > 0" class="max-h-48 overflow-y-auto">
            ...
            >
              <!-- Status Badge -->
              <span 
                class="status-badge inline-flex items-center px-2 py-1 text-xs font-semibold rounded-full mr-3 flex-shrink-0"
  ...
  setup(props, { emit }) {
    ...
    const getStatusStyle = (status) => {
      ...
      const style = {
        color: 'white',
        backgroundColor: status.color || getDefaultStatusColor(status.name)
      };
