...
/**
 * SmartDataTable - Advanced data table component with sorting, filtering, pagination
 * 
 * @component DataTable
 * @example
 * <DataTable
...
export default defineComponent({
  ...
  props: {
     ...
     * Each column should have: key, label, sortable?, type?, align?, width?
     */
    columns: {
      type: Array,
      required: true,
    ...
    /**
     * Pagination object with current_page, last_page, per_page, total, from, to
     */
    pagination: {
      type: Object,
      default: () => ({
  ...
  emits: [
    /**
     * Emitted when table should be sorted
     * @event sort
     * @property {object} payload - { column: string, direction: string }
     */
    'sort',
    
    /**
     * Emitted when page should be changed
     * @event page-change
    ...
    /**
     * Emitted when per page count should be changed
     * @event per-page-change
     * @property {number} perPage - New per page count
     */
    'per-page-change',
     ...
     * @event row-click
     * @property {object} row - Clicked row data
     */
    'row-click',
     ...
     * @event column-resize
     * @property {object} payload - { column: string, width: number }
     */
    'column-resize',
     ...
     * @property {object} payload - { column: string, visible: boolean }
     */
    'column-visibility',
     ...
     * @property {array} selected - New selected rows array
     */
    'update:selected'
  ],
  setup(props, { emit }) {
