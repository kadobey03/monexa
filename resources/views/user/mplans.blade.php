...
<div class="w-full max-w-6xl mx-auto px-2 sm:px-3 md:px-4 py-2 sm:py-3 md:py-4">
    ...
    <div class="mb-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">{{ __('user.plans.navigation_title') }}</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">{{ __('user.plans.page_title') }}</h1>
                <p class="text-gray-600 dark:text-gray-300">{{ __('user.plans.page_subtitle') }}</p>
            </div>
    ...
    <div x-data="{ selectedPlan: null }" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:transform hover:-translate-y-1 border border-gray-100 dark:border-gray-700"
                ...
                <div class="pt-8 px-6 pb-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-800 text-center">
                    ...
                    <div class="text-3xl font-bold text-blue-600 dark:text-blue-400">
                        ...
                        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">{{ __('user.plans.minimum') }}</span>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <p class="text-gray-700 dark:text-gray-300">
                                    <span class="font-medium">{{ __('user.plans.min_investment') }}:</span>
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <p class="text-gray-700 dark:text-gray-300">
                                    <span class="font-medium">{{ __('user.plans.max_investment') }}:</span>
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <p class="text-gray-700 dark:text-gray-300">
                                    <span class="font-medium">{{ __('user.plans.return_rate') }}:</span>
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <p class="text-gray-700 dark:text-gray-300">
                                    <span class="font-medium">{{ __('user.plans.duration') }}:</span>
                        ...
                        <div x-data="{ amount: '{{$plan->min_price}}' }" class="space-y-4">
                            ...
                            <div>
                                <label for="amount-{{$index}}" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    {{ __('user.plans.investment_amount') }} ({{Auth::user()->currency}})
                                </label>
                                ...
                                <div class="relative">
                                    ...
                                    <input 
                                        ...
                                        max="{{$plan->max_price}}" 
                                        x-model="amount"
                                        placeholder="{{ __('user.plans.enter_amount') }}"
                                ...
                                <div class="mt-2 text-center">
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ __('user.plans.potential_return') }}:
        ...
        @empty
            ...
            <div class="col-span-full flex flex-col items-center justify-center p-12 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700">
                ...
                <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">{{ __('user.plans.no_plans_available') }}</h3>
                <p class="text-gray-600 dark:text-gray-400 text-center max-w-md mb-6">
                    {{ __('user.plans.no_plans_message') }}
                </p>
                <a href="{{ route('dashboard') }}" class="inline-flex items-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200">
                    ...
                    {{ __('user.plans.return_dashboard') }}
                </a>
            </div>
        @endforelse
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-8 border border-gray-100 dark:border-gray-700">
        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center">
            ...
            {{ __('user.plans.investment_guide') }}
        </h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="flex space-x-4">
                ...
                <div>
                    <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-1">{{ __('user.plans.guide_choose') }}</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">{{ __('user.plans.guide_choose_desc') }}</p>
                </div>
            </div>
            ...
            <div class="flex space-x-4">
                ...
                <div>
                    <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-1">{{ __('user.plans.guide_secure') }}</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">{{ __('user.plans.guide_secure_desc') }}</p>
                </div>
            </div>
            ...
            <div class="flex space-x-4">
                ...
                <div>
                    <h4 class="text-lg font-medium text-gray-900 dark:text-white mb-1">{{ __('user.plans.guide_earn') }}</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">{{ __('user.plans.guide_earn_desc') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700">
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold text-center text-gray-900 dark:text-white mb-2" id="noPlansModalTitle">{{ __('user.plans.modal_no_plans') }}</h3>
                <p class="text-gray-600 dark:text-gray-400 text-center mb-6">
                    {{ __('user.plans.modal_no_plans_desc') }}
                </p>
