...
@pushOnce('scripts')
<script>
// Lead edit modal functionality is now integrated into the main Alpine.js scope
// All modal variables and methods are available in the main leadsTableData() function
console.log('Lead edit modal script loaded - functionality integrated into alpine-data.js');
</script>
@endPushOnce
