                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 overflow-hidden">
                        <div class="bg-gradient-to-br from-orange-500 to-red-600 p-6 text-white relative">
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-orange-100 text-sm font-medium">Toplam Temsilci</p>
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 overflow-hidden">
                        <div class="bg-gradient-to-br from-blue-500 to-indigo-600 p-6 text-white relative">
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-blue-100 text-sm font-medium">Toplam Yönlendirme</p>
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 overflow-hidden">
                        <div class="bg-gradient-to-br from-green-500 to-emerald-600 p-6 text-white relative">
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-green-100 text-sm font-medium">Ortalama Performans</p>
                    ...
                    <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200 overflow-hidden">
                        <div class="bg-gradient-to-br from-purple-500 to-pink-600 p-6 text-white relative">
                            ...
                            <div class="relative z-10">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-purple-100 text-sm font-medium">En İyi Performans</p>
                    ...
                    <div class="overflow-x-auto">
                        <table id="agentTable" class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Temsilci</th>
                                    <th scope="col" class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Yönlendirilen Müşteriler</th>
                                    <th scope="col" class="px-6 py-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Performans</th>
                                    ...
                                    <tr>
                                        <td colspan="4" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <h3 class="text-lg font-medium text-gray-900 mb-2">Henüz Temsilci Bulunmuyor</h3>
                                                <p class="text-gray-500 mb-6">İlk temsilcinizi eklemek için yukarıdaki butonu kullanın.</p>
            ...
            <div class="bg-gradient-to-r from-green-500 to-emerald-600 p-6 rounded-t-2xl text-white">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 class="text-xl font-bold">Yeni Temsilci Ekle</h3>
                    </div>
                ...
                <form method="post" action="{{ action('App\Http\Controllers\Admin\LogicController@addagent') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="user" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200">
                            <option value="" disabled selected>Temsilci olacak kullanıcıyı seçin</option>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               placeholder="Yönlendirilen kullanıcı sayısını girin">
                        <p class="text-xs text-gray-500 mt-1">Temsilcinin mevcut performansını yansıtmak için başlangıç değeri</p>
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all scale-95">
            ...
            <div class="bg-gradient-to-r from-red-500 to-pink-600 p-6 rounded-t-2xl text-white">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h3 class="text-xl font-bold">Temsilciyi Kaldır</h3>
                    </div>
            ...
            <div class="p-6 text-center">
                <div class="mb-4">
                    ...
                    <h4 class="text-lg font-bold text-gray-900 mb-2">Emin misiniz?</h4>
                    <p class="text-gray-600 mb-4">
                        <span id="agentNameToDelete" class="font-semibold"></span> isimli temsilciyi kaldırmak istediğinizden emin misiniz?
                    </p>
