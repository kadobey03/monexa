    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                ...
                <div class="mb-6">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-center">
                            <x-heroicon name="bitcoin" class="w-5 h-5 text-yellow-500 mr-3" />
                            <span class="text-gray-700 dark:text-gray-300">Bitcoin Yatırım Platformları</span>
                        </li>
                        <li class="flex items-center">
                            <x-heroicon name="building-2" class="w-5 h-5 text-blue-500 mr-3" />
                            <span class="text-gray-700 dark:text-gray-300">Çevrimiçi Bankacılık Sistemleri</span>
                        </li>
                        <li class="flex items-center">
                            <x-heroicon name="arrow-left-right" class="w-5 h-5 text-green-500 mr-3" />
                            <span class="text-gray-700 dark:text-gray-300">Kripto Borsası Platformları</span>
                        </li>
                        <li class="flex items-center">
                            <x-heroicon name="truck" class="w-5 h-5 text-purple-500 mr-3" />
        ...
        <div class="bg-white dark:bg-admin-800 rounded-2xl shadow-lg border border-admin-200 dark:border-admin-700 overflow-hidden">
            <div class="bg-green-600 text-white p-6">
                <h3 class="text-xl font-bold flex items-center">
                    <x-heroicon name="server" class="w-6 h-6 mr-3" />
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-center">
                            <x-heroicon name="check-circle" class="w-5 h-5 text-green-500 mr-3" />
                ...
                <div class="bg-blue-50 dark:bg-blue-900/50 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    <div class="flex items-center">
                        <x-heroicon name="information-circle" class="w-5 h-5 text-blue-600 dark:text-blue-400 mr-2" />
                        <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        ...
        <div class="bg-white dark:bg-admin-800 rounded-2xl shadow-lg border border-admin-200 dark:border-admin-700 overflow-hidden">
            <div class="bg-yellow-500 text-white p-6">
                <h3 class="text-xl font-bold flex items-center">
                    <x-heroicon name="shield-check" class="w-6 h-6 mr-3" />
        ...
        <div class="bg-white dark:bg-admin-800 rounded-2xl shadow-lg border border-admin-200 dark:border-admin-700 overflow-hidden">
            <div class="bg-purple-600 text-white p-6">
                <h3 class="text-xl font-bold flex items-center">
                    <x-heroicon name="paintbrush" class="w-6 h-6 mr-3" />
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-center">
                            <x-heroicon name="palette" class="w-5 h-5 text-blue-500 mr-3" />
                            <span class="text-gray-700 dark:text-gray-300">Özel Logo ve Markalama</span>
                        </li>
                        <li class="flex items-center">
                            <x-heroicon name="smartphone" class="w-5 h-5 text-green-500 mr-3" />
                            <span class="text-gray-700 dark:text-gray-300">UI/UX İyileştirmeleri</span>
                        </li>
                        <li class="flex items-center">
                            <x-heroicon name="magnifying-glass" class="w-5 h-5 text-yellow-500 mr-3" />
                            <span class="text-gray-700 dark:text-gray-300">Mobil ve SEO Optimizasyonu</span>
                        </li>
                        <li class="flex items-center">
                            <x-heroicon name="eye" class="w-5 h-5 text-purple-500 mr-3" />
                ...
                <div class="bg-green-50 dark:bg-green-900/50 border border-green-200 dark:border-green-800 rounded-lg p-4">
                    <div class="flex items-center">
                        <x-heroicon name="view-finder" class="w-5 h-5 text-green-600 dark:text-green-400 mr-2" />
                        <div>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300">
                        <x-heroicon name="send" class="w-12 h-12 text-white mx-auto mb-4" />
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300">
                        <x-heroicon name="globe" class="w-12 h-12 text-white mx-auto mb-4" />
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300">
                        <x-heroicon name="phone" class="w-12 h-12 text-white mx-auto mb-4" />
