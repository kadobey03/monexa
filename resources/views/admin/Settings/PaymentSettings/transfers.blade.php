<div class="space-y-8">
    <!-- Header -->
    <div>
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('admin.payment_settings.transfers.title') }}</h2>
        <p class="text-gray-600 dark:text-gray-400 mt-1">{{ __('admin.payment_settings.transfers.subtitle') }}</p>
    </div>
    ...
    <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl shadow-xl border border-green-200 dark:border-green-800 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-4">
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="text-xl font-bold text-white">{{ __('admin.payment_settings.transfers.system_title') }}</h3>
                    <p class="text-green-100 mt-1">{{ __('admin.payment_settings.transfers.system_description') }}</p>
                </div>
            </div>
        </div>
            ...
            <form action="javascript:void(0)" method="POST" id="trasfer" class="space-y-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <h4 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('admin.payment_settings.transfers.status_title') }}</h4>
                    </div>
                    ...
                    <div class="bg-white dark:bg-admin-800 p-6 rounded-xl border border-gray-200 dark:border-admin-600 shadow-sm">
                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">
                            {{ __('admin.payment_settings.transfers.feature_label') }}
                        </label>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <label class="relative flex items-center cursor-pointer group">
                                ...
                                <div class="flex items-center px-6 py-3 bg-gray-100 dark:bg-admin-700 border border-gray-300 dark:border-admin-600 rounded-lg peer-checked:bg-green-500 peer-checked:border-green-500 peer-checked:text-white transition-all duration-200 group-hover:shadow-md">
                                    ...
                                    <span class="font-medium text-gray-700 dark:text-gray-300 peer-checked:text-white">{{ __('admin.payment_settings.transfers.enabled') }}</span>
                                </div>
                            </label>
                            ...
                            <label class="relative flex items-center cursor-pointer group">
                                ...
                                <div class="flex items-center px-6 py-3 bg-gray-100 dark:bg-admin-700 border border-gray-300 dark:border-admin-600 rounded-lg peer-checked:bg-red-500 peer-checked:border-red-500 peer-checked:text-white transition-all duration-200 group-hover:shadow-md">
                                    ...
                                    <span class="font-medium text-gray-700 dark:text-gray-300 peer-checked:text-white">{{ __('admin.payment_settings.transfers.disabled') }}</span>
                                </div>
                            </label>
                        </div>
                        
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-3">
                            {{ __('admin.payment_settings.transfers.feature_help') }}
                        </p>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 dark:border-admin-600 pt-8">
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <h4 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('admin.payment_settings.transfers.limits_title') }}</h4>
                    </div>
                        ...
                        <div class="bg-white dark:bg-admin-800 p-6 rounded-xl border border-gray-200 dark:border-admin-600 shadow-sm">
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                                <span class="flex items-center">
                                    ...
                                    {{ __('admin.payment_settings.transfers.minimum_amount') }}
                                </span>
                            </label>
                            <div class="relative">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                {{ __('admin.payment_settings.transfers.minimum_amount_help') }}
                            </p>
                        </div>
                        ...
                        <div class="bg-white dark:bg-admin-800 p-6 rounded-xl border border-gray-200 dark:border-admin-600 shadow-sm">
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">
                                <span class="flex items-center">
                                    ...
                                    {{ __('admin.payment_settings.transfers.commission_rate') }}
                                </span>
                            </label>
                            <div class="relative">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                {{ __('admin.payment_settings.transfers.commission_help') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
                    <div class="flex">
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-blue-800 dark:text-blue-200 mb-2">{{ __('admin.payment_settings.transfers.info_title') }}</h4>
                            <ul class="text-xs text-blue-700 dark:text-blue-300 space-y-1">
                                <li>• {{ __('admin.payment_settings.transfers.info_1') }}</li>
                                <li>• {{ __('admin.payment_settings.transfers.info_2') }}</li>
                                <li>• {{ __('admin.payment_settings.transfers.info_3') }}</li>
                                <li>• {{ __('admin.payment_settings.transfers.info_4') }}</li>
                                <li>• {{ __('admin.payment_settings.transfers.info_5') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end pt-6 border-t border-gray-200 dark:border-admin-600">
                    <button type="submit" class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1">
                        ...
                        <span id="transferButtonText">{{ __('admin.payment_settings.transfers.save_settings') }}</span>
                    </button>
                </div>
            </form>
        </div>
