        ...
        <div class="flex items-center">
            <div class="flex-shrink-0">
                <div class="w-12 h-12 bg-blue-100 dark:bg-blue-800 rounded-lg flex items-center justify-center">
                    <x-heroicon name="user-check" class="h-6 w-6 text-blue-600 dark:text-blue-400" />
                </div>
            </div>
            <div class="ml-4">
                        ...
                        @forelse ($ag_r as $client)
                            <tr class="hover:bg-gray-50 dark:hover:bg-admin-700">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <div class="h-10 w-10 rounded-full bg-gray-100 dark:bg-admin-700 flex items-center justify-center">
                                                <x-heroicon name="user" class="h-5 w-5 text-gray-600 dark:text-gray-400" />
                                            </div>
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <div class="flex items-center">
                                        <x-heroicon name="currency-dollar" class="h-4 w-4 text-green-600 dark:text-green-400 mr-1" />
