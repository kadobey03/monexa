            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-4xl font-bold text-white mb-2">
                        <i data-lucide="user-check" class="inline w-10 h-10 mr-3 text-blue-200"></i>
    ...
    <div class="bg-white dark:bg-admin-800 rounded-2xl shadow-lg border border-admin-200 dark:border-admin-700 overflow-hidden">
        <div class="p-6 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-admin-900 dark:to-admin-800 border-b border-admin-200 dark:border-admin-700">
            <h3 class="text-xl font-bold text-gray-900 dark:text-white flex items-center">
                <i data-lucide="list" class="w-6 h-6 mr-3 text-blue-600 dark:text-blue-400"></i>
                KYC Başvuru Listesi
            </h3>
                ...
                <thead class="bg-gray-50 dark:bg-admin-900">
                    <tr>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-900 dark:text-white">
                            <i data-lucide="user" class="inline w-4 h-4 mr-2 text-gray-400"></i>
                            Kullanıcı
                        </th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-900 dark:text-white">
                            <i data-lucide="shield" class="inline w-4 h-4 mr-2 text-gray-400"></i>
                            KYC Durumu
                        </th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-900 dark:text-white">
                            <i data-lucide="settings" class="inline w-4 h-4 mr-2 text-gray-400"></i>
                            İşlemler
                        </th>
                    </tr>
                </thead>
