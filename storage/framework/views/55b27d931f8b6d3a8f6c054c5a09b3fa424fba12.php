...
} elseif ($_instance->childHasBeenRendered('uzfqchR')) {
    $componentId = $_instance->getRenderedChildComponentId('uzfqchR');
    $componentTag = $_instance->getRenderedChildComponentTagName('uzfqchR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uzfqchR');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('uzfqchR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /datas/monexafi/public_html/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>