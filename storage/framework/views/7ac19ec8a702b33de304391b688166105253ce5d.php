...
} elseif ($_instance->childHasBeenRendered('SashzP8')) {
    $componentId = $_instance->getRenderedChildComponentId('SashzP8');
    $componentTag = $_instance->getRenderedChildComponentTagName('SashzP8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SashzP8');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('SashzP8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /datas/monexafi/public_html/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>