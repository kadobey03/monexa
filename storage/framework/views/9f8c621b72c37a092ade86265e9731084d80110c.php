                ...
                <div class="p-4 sm:p-6 space-y-6 sm:space-y-8">
                                ...
                                <div class="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <?php if($payment_mode->methodtype == 'crypto'): ?>
                                            ...
                                            <?php else: ?>
                                                <p class="text-xs sm:text-sm text-gray-400 break-words">Transfer <?php echo e($amount); ?><?php echo e(Auth::user()->currency); ?> to the bank account details</p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="flex items-start gap-3">
                    ...
                    <div class="space-y-6 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-8">
                        ...
                        <div class="space-y-4 sm:space-y-6">
                                ...
                                <div class="relative bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700 space-y-4">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <input type="text" value="<?php echo e($payment_mode->bankname); ?>" readonly
                                                   class="flex-1 bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm">
                                            <button type="button" @click="copyToClipboard('<?php echo e($payment_mode->bankname); ?>')"
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <input type="text" value="<?php echo e($payment_mode->account_name); ?>" readonly
                                                   class="flex-1 bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm">
                                            <button type="button" @click="copyToClipboard('<?php echo e($payment_mode->account_name); ?>')"
                                                    class="p-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-white transition-colors">
                                                <i data-lucide="copy" class="w-4 h-4"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <input type="text" value="<?php echo e($payment_mode->account_number); ?>" readonly
                                                   class="flex-1 bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm">
                                            <button type="button" @click="copyToClipboard('<?php echo e($payment_mode->account_number); ?>')"
                                                    class="p-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-white transition-colors">
                                                <i data-lucide="copy" class="w-4 h-4"></i>
                                            </button>
                                        </div>
                                    ...
                                    <?php if($payment_mode->swift_code): ?>
                                    <!-- Swift Code -->
                                    <div class="space-y-2">
                                        <label class="text-sm font-medium text-gray-400">Swift Code</label>
                                        <div class="flex items-center gap-2">
                                            <input type="text" value="<?php echo e($payment_mode->swift_code); ?>" readonly
                                                   class="flex-1 bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white text-sm">
                                            <button type="button" @click="copyToClipboard('<?php echo e($payment_mode->swift_code); ?>')"
                                                    class="p-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-white transition-colors">
                                                <i data-lucide="copy" class="w-4 h-4"></i>
                                            </button>
                                        </div>
                            ...
                            <p class="text-xs sm:text-sm text-gray-400 text-center">
                                Transfer funds using your bank's online banking or mobile app
                            </p>
                        </div>
                        <?php endif; ?>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="mt-2 text-center">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-yellow-500/20 text-yellow-400 border border-yellow-500/30">
                                        ...
                                        Network: <?php echo e($payment_mode->network); ?>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/up.elitemaxpro.click/resources/views/user/payment.blade.php ENDPATH**/ ?>