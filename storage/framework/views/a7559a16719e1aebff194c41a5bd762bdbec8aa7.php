...
} elseif ($_instance->childHasBeenRendered('Rc7YZKP')) {
    $componentId = $_instance->getRenderedChildComponentId('Rc7YZKP');
    $componentTag = $_instance->getRenderedChildComponentTagName('Rc7YZKP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Rc7YZKP');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('Rc7YZKP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/elitemaxpro/up.elitemaxpro.click/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>