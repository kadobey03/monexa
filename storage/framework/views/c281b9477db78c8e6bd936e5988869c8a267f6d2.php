    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item <?php echo e(request()->routeIs('admin.demo.*') ? 'active' : ''); ?>">
                    ...
                    <div class="collapse" id="demo">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="<?php echo e(route('admin.demo.users')); ?>">
                                    <span class="sub-item">Manage Demo Users</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin.demo.trades')); ?>">
...
<!-- End Sidebar -->
<?php /**PATH /home/elitemaxpro/up.elitemaxpro.click/resources/views/admin/sidebar.blade.php ENDPATH**/ ?>