...
} elseif ($_instance->childHasBeenRendered('vpE23vr')) {
    $componentId = $_instance->getRenderedChildComponentId('vpE23vr');
    $componentTag = $_instance->getRenderedChildComponentTagName('vpE23vr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vpE23vr');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('vpE23vr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/up.elitemaxpro.click/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>