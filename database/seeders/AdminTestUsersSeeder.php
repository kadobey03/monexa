    ...
    public function run(): void
    {
        ...
        $testAdmins = [
            ...
            [
                ...
                'password' => Hash::make('Test123!'),
                'role_id' => 6, // retention_head (support_head yerine)
                'admin_group_id' => 3,
                'supervisor_id' => 101,
            ...
            [
                ...
                'password' => Hash::make('Test123!'),
                'role_id' => 4, // team_leader (senior_sales yerine)
                'admin_group_id' => 2,
                'supervisor_id' => 102,
            ...
            [
                ...
                'password' => Hash::make('Test123!'),
                'role_id' => 5, // sale (sales_representative yerine)
                'admin_group_id' => 2,
                'supervisor_id' => 102,
            ...
            [
                ...
                'password' => Hash::make('Test123!'),
                'role_id' => 5, // sale (junior_sales yerine)
                'admin_group_id' => 4,
                'supervisor_id' => 104,
                'subordinate_ids' => null,
                'employee_id' => 'EMP007',
            ...
            [
                ...
                'password' => Hash::make('Test123!'),
                'role_id' => 8, // retention (support_specialist yerine)
                'admin_group_id' => 3,
                'supervisor_id' => 103,
                'subordinate_ids' => null,
                'employee_id' => 'EMP009',
